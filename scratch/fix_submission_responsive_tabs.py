...
def fix_submission_responsive_tabs():
    ...
    tabs_pattern = re.compile(r'<div class="flex items-center justify-between border-b border-gray-100 p-6 w-full bg-white shrink-0 z-20" id="categoryTabs">.*?</div>\s*<!-- Dynamic Form Content -->', re.DOTALL)
    ...
    new_tabs_html = '''<div class="flex items-center justify-between border-b border-gray-100 p-4 w-full bg-white shrink-0 z-20" id="categoryTabs">
                                    ...
                                    <div class="flex-1 h-[2px] bg-gray-100 relative mx-2"></div>
    ...
    html = tabs_pattern.sub(new_tabs_html, html)
    ...
    new_js = '''tabs.forEach((tab, i) => {
                                            ...
                                            if (i === index) {
                                                ...
                                                document.getElementById('current-category-title').textContent = tabTitle;
                                                document.getElementById('current-category-desc').textContent = tab.getAttribute('data-desc');
                                                document.getElementById('current-category-icon').setAttribute('data-lucide', tabIcon);
                                            } else {
...
if __name__ == '__main__':
    fix_submission_responsive_tabs()
